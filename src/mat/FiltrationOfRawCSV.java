...
public class FiltrationOfRawCSV {
	...
	public static void newCSV(String fileName, int size) throws FileNotFoundException{
		/**
		 * this function create whole new csv file that contains the union of all csv files in the folder
		 */
		
		Scanner file=new Scanner(new File(fileName));
		Scanner file1 = new Scanner(new File(fileName));
		String[][] matrix = new String[size][11];	
	...
	public static void selectionSort(ArrayList<Integer> amp,String[][] matrix,int d){
		/**
		 * this function uses selection sort to sort networks in case of 10 networks from same time
		 */
	...
	public static void swap(String[][] arr,int index,int h){
		/**
		 * this function is help function for the selection sort above
		 */
	...
	public static void lastFile(ArrayList<Integer> networksFromSameTime,String[][] matrix,ArrayList<String> time){
		/**
		 * this function create last and sorted csv file in the folder
		 */
	...
	public static ArrayList<String[]> matrixToArrayList(String matrix[][]){
		/**
		 * this function take the last matrix that contain the sorted information and move it to array list of strings
		 */
	...
	public static String[][] sort(String arr[][]) {
		/**
		 * this function sorting the last matrix of information about the networks
		 */

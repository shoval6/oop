...
public class Filter {
	...
	/**
	 * This function helps the user select sort method .
	 * 
	 * 
	 */
	public static void choose() throws FileNotFoundException, ParseException{
		...
		case 3:
			...
			break;
		case 4:
			System.out.println("As you wish...Kml file had been created - Process done !");
			break;
	...
	/**
	 * This function filters the information by time .
	 *  receives start and end time , and returns ArrayList with the filtered information.  
	 *
	 */
	...
	/**
	 * This function checks if the time is in the range that the user entered .
	 *	
	 */
	...
	/**
	 * This function checks if the input is in the correct format . 
	 *
	 */
	...
	/**
	 * This function filters the information by place .
	 *  receives lat and lon Coordinates , and returns ArrayList with the filtered information.  
	 *
	 */
	...
	/**
	 *  This function checks the input of lat and lon , that the user enterd .
	 *
	 */
	...
	/**
	 * This function filters the information by Device ID .
	 *  receives the name of the device , and returns ArrayList with the filtered information.  
	 *
	 */
	...
	/**
	 * This function checks if the input of the user is correct .
	 *
	 */
	...
	/**
	 * This function prints the menu table of sorting .
	 */
